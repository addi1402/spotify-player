export default function Controls({volume, handleVolumeChange, handlePreviousSong, handleNextSong, isPlaying, togglePlayPause, showVolumeControl, setShowVolumeControl}){
    return (
