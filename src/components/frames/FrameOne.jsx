...
const FrameOne = () => {
  return (
    <div className="w-full h-16 sm:w-full sm:flex-row sm:items-center lg:w-1/6 lg:h-full lg:flex-col lg:items-start lg:justify-between md:w-full md:flex-row md:items-center px-8 py-8 flex justify-between items-center">
      <a href="/">
        <img
          src="/logo.svg"
